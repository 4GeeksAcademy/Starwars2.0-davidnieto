    ...
    <div className="col-12 col-md-6 col-lg-4 p-2">
      <div className="card  m-3">
        ...
        <div className="card-body text-white bg-dark">
          ...
          <p className="card-text">Clase: {properties.model}</p>
          <div className="d-flex justify-content-between align-items-center">
            <a href="#" className="btn btn-danger" onClick={(e) => handleClick(e, id)}> ♥ </a>
            <Link className="btn btn-success" to={`/StartShipDetailsView/${id}`} >Mas detalles</Link> </div>
        </div>
      </div>
    </div>
  );
